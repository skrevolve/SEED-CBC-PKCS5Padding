...
<html>
<head>
	<title>WPAY 표준 결제인증(오픈뱅킹 계좌) 결과</title>
...
<%
	...
	if(param_resultCode.equals("0000")){
		...
		srcStr = srcStr + "&wpayDomain="+param_wpayDomain;
	...
	out.println("<br/>");
	out.println("#### WPAY 표준 결제인증(요픈뱅킹 계좌) 결과 signature 확인 실패 ####");
	out.println("<pre>");
	...
	System.out.println(e);
		...
		*/
		...
		out.println("<br/>");
		out.println("#### WPAY 표준 결제인증(오픈뱅킹 계좌) 결과 실패 ####");
		out.println("<pre>");
		...
		<tr>
			<td bgcolor="6095BC" align="center" style="padding:10px">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" style="padding:20px">
					...
					<tr>
						<td >
							<span style="font-size:20px"><b>WPAY 표준 결제인증(오픈뱅킹 계좌) 결과 파라미터 정보</b></span><br/>
						</td>
					</tr>
					<tr >
						<td >
