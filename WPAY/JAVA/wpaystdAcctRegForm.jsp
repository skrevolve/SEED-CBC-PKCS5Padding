...
<html>
<head>
<title>WPAY 표준 결제정보(오픈뱅킹 계좌) 등록 정보입력</title>
...
<!--
	function goNext(frm)
	{
		var url = "wpaystdAcctRegRequest.jsp";
...
<body bgcolor="#FFFFFF" text="#242424" leftmargin=0 topmargin=15
	...
	<form id="SendPayForm_id" name="SendPayForm_id" method="POST">
		...
		<div
			...
			WPAY 표준 결제정보(오픈뱅킹 계좌) 등록 샘플</div>
			...
			<tr>
				<td bgcolor="6095BC" align="center" style="padding: 10px">
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							<td>이 페이지는 WWPAY 표준 결제정보(오픈뱅킹 계좌) 등록을 위한 예시입니다.<br /> <br /> <br /> Form에
								설정된 모든 필드의 name은 대소문자 구분하며,<br /> 이 Sample은 WPAY 표준 결제정보(오픈뱅킹 계좌) 등록을 위해서 설정된 Form으로
						...
						<tr>
							<td>
								...
								<button type="button" onclick="goNext(this.form);return false;"
									style="padding: 10px">결제정보(오픈뱅킹 계좌) 등록</button>
							</td>
						</tr>
						<tr>
							<td>
									...
									<tr>
										...
										<b>***** 필 수 *****</b>
											<div
												...
												<br /> <input class="input" style="width: 100%;color:gray;" name="returnUrl" value="<%=strCurrentDomain%>/wpaystdAcctRegReturn.jsp" readOnly><br />
