...
<!--
	function goNext(frm)
	{
		var url = "wpaystdMemRegRequest.jsp";
								...
								<tr>
									<td style="text-align:left;">
										...
										<div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
											...
											<br /><input  class="input" style="width:100%;" name="userId" id="userId" value="wpayTestUser01" >
											
											<br /><b>returnUrl</b> : 회원가입 결과전달 URL
											<br /><input  class="input" style="width:100%;color:gray;" name="returnUrl" id="returnUrl" value="<%=strCurrentDomain%>/wpaystdMemRegReturn.jsp"  readOnly>
										</div>
										<br /><br />
