...
<html>
<head>
<title>WPAY 표준 결제정보 삭제 정보입력</title>
...
<!--
	function goNext(frm) {
		var url = "wpaystdDelPayInfoRequest.jsp";
			...
			<tr>
				<td bgcolor="6095BC" align="center" style="padding: 10px">
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							<td>이 페이지는 WPAY 표준 결제정보 삭제를 위한 예시입니다.<br /> <br /> <br />
								Form에 설정된 모든 필드의 name은 대소문자 구분하며,<br /> 이 Sample은 WPAY 표준 결제정보 삭제를 위해서
						...
						<tr>
							<td>
								...
								<button type="button" onclick="goNext(this.form);"
									style="padding: 10px">결제정보 삭제</button>
							</td>
						</tr>
						<tr>
							<td>
									...
									<tr>
										<td style="text-align: left;"><br /> <b>***** 필 수 *****</b>
											<div style="border: 2px #dddddd double; padding: 10px; background-color: #f3f3f3;">
												...
												<br /> <b>wpayUserKey</b> : 이니시스에서 발행한 wpayUserKey <br />
												<input class="input" style="width: 100%;" name="wpayUserKey" value=""><br /> 
												
												<br /> <b>wpayToken</b> : 이니시스에서 발행한 wpayToken <br />
												<input class="input" style="width: 100%;" name="wpayToken" value=""><br /> 
											</div> 
											<br /><br />
