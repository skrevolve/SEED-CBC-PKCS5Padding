...
<html>
<head>
<title>WPAY 표준 결제승인(오픈뱅킹 계좌) 요청 정보입력</title>
...
<!--
	function goNext(frm) {
		var url = "wpaystdPayApplAcctRequest.jsp";
...
<body bgcolor="#FFFFFF" text="#242424" leftmargin=0 topmargin=15
	...
	<form id="SendPayForm_id" name="SendPayForm_id" method="POST">
		...
		<div
			...
			WPAY 표준 결제승인(오픈뱅킹 계좌) 요청 샘플(API)</div>
			...
			<tr>
				<td bgcolor="6095BC" align="center" style="padding: 10px">
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							<td>이 페이지는 WPAY 표준 결제승인(오픈뱅킹 계좌) 요청을 위한 예시입니다.<br /> <br /> <br />
								Form에 설정된 모든 필드의 name은 대소문자 구분하며,<br /> 이 Sample은 WPAY 표준 결제승인(오픈뱅킹 계좌) 요청을 위해서
						...
						<tr>
							<td>
								...
								<button type="button" onclick="goNext(this.form);"
									style="padding: 10px">결제승인(오픈뱅킹 계좌) 요청</button>
							</td>
						</tr>
						<tr>
							<td>
									...
									<tr>
										<td style="text-align: left;"><br /> <b>***** 필 수 *****</b>
											<div style="border: 2px #dddddd double; padding: 10px; background-color: #f3f3f3;">
												...
												<br /> <input class="input" style="width: 100%;" name="wtid" value=""><br />
											</div> 
											<br /><br />
											...
											<div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
												...
												<br /> <b>tax</b> : 과세금액 
												<br /> <input class="input" style="width: 100%;" name="tax" value=""><br />
											
												<br /> <b>taxFree</b> : 비과세금액 
												<br /> <input class="input" style="width: 100%;" name="taxFree" value=""><br />
											</div>
										</td>
									</tr>
								</table>
