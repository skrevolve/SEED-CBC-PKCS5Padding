...
// wpayToken 이 없으면 이걸 실행 .

$mid = "INIwpayT03"; // 가맹점 ID
$wpayUserKey = '2dQHJN89t/xI6YcIjLiL21zrLtKvAL9MUv8ckT2fE4k='; // 가입시 이니시스에서 발행한 wpayUserKey
$returnUrl = '[YOUR_HOST]/wpay/wpay_card_reg_return'; // 신용카드 등록 결과전달 URL
$ci = 'oMUtEjPHhU0wPU1F9F4l4yQQhe9HBKHUh9H0M33l4arWsteF735DgEIEXJxaYXDaRfVxfNWNPftU337XFrqXLQ=='; // 고객의 ci
?>
<!DOCTYPE html>
<html>
<head>
...
<script language="javascript">
	function goNext(frm)
	{
        var url = "[YOUR_HOST]/wpay/wpay_card_reg_request";
...
<body bgcolor="#FFFFFF" text="#242424" leftmargin=0 topmargin=15
	...
	<form id="SendPayForm_id" name="SendPayForm_id" method="POST">
        ...
        <br /> <input class="input" style="width: 100%;color:gray;" name="returnUrl" value="<?php echo $returnUrl ?>" readOnly><br />
											...
											<div style="border: 2px #dddddd double; padding: 10px; background-color: #f3f3f3;">
												<br /> <b>ci</b> : 고객의 ci
        <br /> <input class="input" style="width: 100%;" name="ci" value="<?php echo $ci ?>"><br />
											</div>
										</td>
									</tr>
								</table>
