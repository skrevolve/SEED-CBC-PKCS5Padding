...
<html>
<head>
    <title>WPAY 표준 결제취소 요청 정보입력</title>
...
<script language="javascript">
    function goNext(frm) {
        var url = "[YOUR_HOST]/wpay/wpay_cancel_request";
        ...
        <tr>
            <td bgcolor="6095BC" align="center" style="padding: 10px">
                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td>이 페이지는 WPAY 표준 결제취소 요청을 위한 예시입니다.<br /> <br /> <br />
                            Form에 설정된 모든 필드의 name은 대소문자 구분하며,<br /> 이 Sample은 WPAY 표준 결제취소 요청을 위해서
                    ...
                    <tr>
                        <td>
                            ...
                            <button type="button" onclick="goNext(this.form);"
                                    style="padding: 10px">결제취소 요청</button>
                        </td>
                    </tr>
                    <tr>
                        <td>
...
<!--                                            <br /> <input class="input" style="width: 100%;" name="wpayUserKey" value=""><br />-->
                                            ...
                                            <br /> <b>tid</b> : 이니시스에서 발행한 WPAY 트랜잭션ID
                                            <br /> <input class="input" style="width: 100%;" name="tid" value=""><br />

                                            <br /> <b>cancelMsg</b> : 취소 요청 메시지 <br />
                                            <input class="input" style="width: 100%;" name="cancelMsg" value="테스트 결제취소"><br />
                                        </div>
                                    </td>
                                </tr>
                            </table>
